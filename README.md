...
2021.07 - 21.10 [(openGL) openGL 라이브러리 활용, 스캔 라인 렌더링 구현](https://limbsoo.github.io/tags/opengl/)
- openGL glut 라이브러리를 활용, 스캔 라인을 통한 렌더링 효과를 구현하였습니다.
	(Texture mapping, Shadow mapping, Environment Mapping 등)
	
 
2021.10 - 21.12 [(DX11) DX11 환경 렌더링 구현](https://limbsoo.github.io/tags/tutorial/)
- DirectX11 환경에서 DX11 rendering pipeline을 통한 렌더링 효과를 구현하였습니다.
	(Lighting, Shadow mapping, Environment Mapping 등)

2022.01 - 2023.02 [(DX11/HLSL) 모션 블러 구현](https://limbsoo.github.io/tags/motionblur/)
- accumulation 방식을 통한 모션 블러 효과 구현 using [accumulation method](https://limbsoo.github.io/posts/DX11-Motion-Blur-using-Accumulation-method/)
	모션 블러 생성을 위해 한 프레임에서 발생한 물체의 움직임을 일정 횟수만큼 나누고, 이를 하나의 이미지로 합쳐 모션 블러 효과를 생성하는 방법을 구현하였습니다.

<center><img src="https://github.com/limbsoo/limbsoo.github.io/assets/96706760/544d21f9-6471-47f8-9c2e-15a5e6e6a990" alt width=200>
<em>한 프레임에서 발생한 물체의 움직임</em>
</center>
...
<em>이미지를 겹쳐, 픽셀 색상 결정</em>
</center>


- motion vector sharing 방식을 통한 모션 블러 효과 구현 using [motion vector sharing](https://limbsoo.github.io/posts/DX11-Motion-Blur-using-motion-vector-sharing/)
...
- depth 별 layer를 사용하는 motion vector sharing 모션 블러 효과 구현 using [depth peeling layer](https://limbsoo.github.io/posts/DX11-Motion-Blur-using-depth-peeling-layer/)
...
- stencil routing을 통한 depth 별 layer motion vector sharing 모션 블러 효과 구현 using [stencil routing peeling layer](https://limbsoo.github.io/posts/DX11-Motion-Blur-stencil-routing/)
...
2023.03 - 2023.12 [(Unity) 유전 알고리즘을 통한 Match-3 game map 자동 생성](https://limbsoo.github.io/tags/match-3game/)
